        ...
        return(
            <Container>
                ...
                <View style={styles.upper}>
                    <Text style={styles.text}>Check the Book Ticket</Text>
                    <SVGImage
                        style={{position:'absolute', width: 40, height: 40, paddingTop:6 ,marginLeft:'40%', backgroundColor:'black' }}
                        source={{uri:'https://image.flaticon.com/icons/svg/819/819546.svg'}}
                        />
                </View>
                <WebView style={{flex:1}}
                    source={{uri: 'https://irfani0.github.io/web-app/#/Ticket'}}
                    style={{ height:1000}}
                />
            </Container>
        );
